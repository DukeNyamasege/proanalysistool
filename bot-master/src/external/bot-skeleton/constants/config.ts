...
export const config = () => ({
    ...
    opposites: {
        ...
        LOOKBACK: [
            {
                LBFLOATCALL: localize('Close-to-Low'),
            },
            {
                LBFLOATPUT: localize('High-to-Close'),
            },
            {
                LBHIGHLOW: localize('High-to-Low'),
            },
        ],
        CALLPUTSPREAD: [
            {
    ...
    DIGIT_CATEGORIES: ['matchesdiffers', 'overunder', 'evenodd', 'highlowticks'],
