...
export default class ContractsFor {
    ...
    async getContractsFor(symbol) {
        ...
        const getContractsForFromApi = async () => {
            ...
            try {
                ...
                if (response?.error) {
                    return this.getVirtualContractsFor(symbol);
                }

                const contracts = response?.contracts_for?.available;
                const safe_contracts = Array.isArray(contracts) && contracts.length ? contracts : this.getVirtualContractsFor(symbol);

                // We don't offer forward-starting contracts in bot.
                const filtered_contracts = safe_contracts.filter(c => c.start_type !== 'forward');
                ...
                console.warn('[ContractsFor] Falling back to Matchestool virtual contract metadata:', error);
                const fallback_contracts = this.getVirtualContractsFor(symbol);
    ...
    getVirtualContractsFor(symbol) {
        const base_contract = {
            cancellation_range: ['5m', '10m', '15m', '30m', '60m'],
            close: '23:59:59',
            exchange_name: 'matchestool-virtual',
        ...
        return [
            build({ barrier_category: 'euro_atm', contract_category: 'callput', contract_type: 'CALL', expiry_type: 'tick' }),
            build({ barrier_category: 'euro_atm', contract_category: 'callput', contract_type: 'PUT', expiry_type: 'tick' }),
            build({ barrier_category: 'euro_atm', contract_category: 'callputequal', contract_type: 'CALLE', expiry_type: 'tick' }),
            build({ barrier_category: 'euro_atm', contract_category: 'callputequal', contract_type: 'PUTE', expiry_type: 'tick' }),
            build({ barrier_category: 'euro_non_atm', contract_category: 'higherlower', contract_type: 'CALL', expiry_type: 'tick' }),
            build({ barrier_category: 'euro_non_atm', contract_category: 'higherlower', contract_type: 'PUT', expiry_type: 'tick' }),
            build({ barrier_category: 'american', contract_category: 'touchnotouch', contract_type: 'ONETOUCH', expiry_type: 'tick' }),
            build({ barrier_category: 'american', contract_category: 'touchnotouch', contract_type: 'NOTOUCH', expiry_type: 'tick' }),
            build({ barrier_category: 'euro_non_atm', contract_category: 'endsinout', contract_type: 'EXPIRYRANGE', expiry_type: 'tick' }),
            build({ barrier_category: 'euro_non_atm', contract_category: 'endsinout', contract_type: 'EXPIRYMISS', expiry_type: 'tick' }),
            build({ barrier_category: 'american', contract_category: 'staysinout', contract_type: 'RANGE', expiry_type: 'tick' }),
            build({ barrier_category: 'american', contract_category: 'staysinout', contract_type: 'UPORDOWN', expiry_type: 'tick' }),
            build({ barrier_category: 'asian', contract_category: 'asians', contract_type: 'ASIANU', expiry_type: 'tick' }),
            build({ barrier_category: 'asian', contract_category: 'asians', contract_type: 'ASIAND', expiry_type: 'tick' }),
            ...
            build({ barrier_category: 'american', contract_category: 'highlowticks', contract_type: 'TICKHIGH', expiry_type: 'tick', last_digit_range: [1, 2, 3, 4, 5] }),
            build({ barrier_category: 'american', contract_category: 'highlowticks', contract_type: 'TICKLOW', expiry_type: 'tick', last_digit_range: [1, 2, 3, 4, 5] }),
            build({ barrier_category: 'reset', contract_category: 'reset', contract_type: 'RESETCALL', expiry_type: 'tick' }),
            build({ barrier_category: 'reset', contract_category: 'reset', contract_type: 'RESETPUT', expiry_type: 'tick' }),
            build({ barrier_category: 'american', contract_category: 'runs', contract_type: 'RUNHIGH', expiry_type: 'tick' }),
            build({ barrier_category: 'american', contract_category: 'runs', contract_type: 'RUNLOW', expiry_type: 'tick' }),
            build({ barrier_category: 'lookback', contract_category: 'lookback', contract_type: 'LBFLOATCALL', expiry_type: 'tick' }),
            build({ barrier_category: 'lookback', contract_category: 'lookback', contract_type: 'LBFLOATPUT', expiry_type: 'tick' }),
            build({ barrier_category: 'lookback', contract_category: 'lookback', contract_type: 'LBHIGHLOW', expiry_type: 'tick' }),
            build({ barrier_category: 'euro_non_atm', contract_category: 'callputspread', contract_type: 'CALLSPREAD', expiry_type: 'tick' }),
            build({ barrier_category: 'euro_non_atm', contract_category: 'callputspread', contract_type: 'PUTSPREAD', expiry_type: 'tick' }),
            build({
